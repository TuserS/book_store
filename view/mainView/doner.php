        ...
        <tr height="500" bgcolor="WhiteSmoke">
            <td align="center">
                <table align="center">
                    ...
                    <hr width="100%">
                    <br> 
					<input type="button" value="Registration as a Publiser" class="button" onclick="window.open('publisherDoner.php')">
				    <br>
					<br>
					<font size="5" face="Consolas" color="SLATEBLUE"><b>User Doner</b></font>
					<br>
					<br>
